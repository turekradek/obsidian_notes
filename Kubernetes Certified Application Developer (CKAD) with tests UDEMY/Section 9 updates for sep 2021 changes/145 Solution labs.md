1. New user michell joined the team . She will be focusing on the nodes in the cluster. Create the required ClusterRoles and ClustarRoleBindings so she gets access to the nodes
