We have provided an incomplete CRDs manifest file called `crd.yaml` under the `/root` directory. Let’s complete it and create a custom resource definition from it.  
